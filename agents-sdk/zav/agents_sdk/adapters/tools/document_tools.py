...
class DocumentTools(ToolsSource):
    ...
    def __init__(
        ...
        self.__config = document_tools_config or DocumentToolsConfig()
...
class DocumentToolsFactory(AgentDependencyFactory):
    ...
    def create(
        cls,
        zav_retriever: Optional[ZAVRetriever] = None,
        document_tools_config: Optional[DocumentToolsConfig] = None,
    ) -> DocumentTools:
        if not zav_retriever:
            raise ValueError("DocumentTools requires a ZAVRetriever")
