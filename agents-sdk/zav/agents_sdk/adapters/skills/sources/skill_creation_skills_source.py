...
class SkillCreationSkillsSourceConfiguration(BaseModel):
    enabled: bool = Field(False, description="Enable skill creation skills source.")
...
class SkillCreationSkillsSourceFactory(AgentDependencyFactory):
    ...
    def create(
        cls,
        skill_creation_skills_source_configuration: SkillCreationSkillsSourceConfiguration = SkillCreationSkillsSourceConfiguration(),  # noqa: E501
    ) -> SkillCreationSkillsSource:
        return SkillCreationSkillsSource(
            enabled=skill_creation_skills_source_configuration.enabled,
        )
