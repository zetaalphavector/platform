...
class TagNoteSkillsSourceConfiguration(BaseModel):
    enabled: bool = False
...
class TagNoteSkillsSourceFactory(AgentDependencyFactory):
    ...
    def create(
        ...
        notes_service: NotesService,
        tags_service: TagsService,
        tag_note_skills_source_configuration: TagNoteSkillsSourceConfiguration = (
        ...
        return TagNoteSkillsSource(
            ...
            tag_ids=tag_note_skills_source_configuration.tag_ids,
            include_favorites=tag_note_skills_source_configuration.include_favorites,
            enabled=tag_note_skills_source_configuration.enabled,
        )
