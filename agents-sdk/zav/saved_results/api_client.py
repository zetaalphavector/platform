...
from zav.saved_results import rest
from zav.saved_results.configuration import Configuration
from zav.saved_results.exceptions import ApiTypeError, ApiValueError, ApiException
from zav.saved_results.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.admin_doc_counts  # this is an instance of the class Endpoint
        api_instance.admin_doc_counts()  # this invokes api_instance.admin_doc_counts.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.admin_doc_counts.callable or self.callable in this class
