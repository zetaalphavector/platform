...
def lazy_import():
    ...
    globals()['ScheduledAgentTaskItem'] = ScheduledAgentTaskItem


class PaginatedResponseScheduledAgentTaskItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'count': (int,),  # noqa: E501
            'results': ([ScheduledAgentTaskItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, count, results, *args, **kwargs):  # noqa: E501
        """PaginatedResponseScheduledAgentTaskItem - a model defined in OpenAPI

        Args:
            count (int):
            results ([ScheduledAgentTaskItem]):
