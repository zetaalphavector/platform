...
def lazy_import():
    ...
    globals()['AgentBundleItem'] = AgentBundleItem
    globals()['PageParams'] = PageParams


class PaginatedResponseAgentBundleItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'count': (int,),  # noqa: E501
            'results': ([AgentBundleItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, count, results, *args, **kwargs):  # noqa: E501
        """PaginatedResponseAgentBundleItem - a model defined in OpenAPI

        Args:
            count (int):
            results ([AgentBundleItem]):
