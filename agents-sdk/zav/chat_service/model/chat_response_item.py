...
class ChatResponseItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'conversation': ([ChatMessage],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, agent_identifier, conversation, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, agent_identifier, conversation, *args, **kwargs):  # noqa: E501
        """ChatResponseItem - a model defined in OpenAPI
