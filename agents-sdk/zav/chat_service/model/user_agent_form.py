...
class UserAgentForm(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, agent_identifier, display_name, *args, **kwargs):  # noqa: E501
        """UserAgentForm - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, agent_identifier, display_name, *args, **kwargs):  # noqa: E501
        """UserAgentForm - a model defined in OpenAPI
