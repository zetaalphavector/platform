...
def lazy_import():
    ...
    globals()['UserAgentItem'] = UserAgentItem


class PaginatedResponseUserAgentItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'count': (int,),  # noqa: E501
            'results': ([UserAgentItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, count, results, *args, **kwargs):  # noqa: E501
        """PaginatedResponseUserAgentItem - a model defined in OpenAPI
