...
def lazy_import():
    ...
    globals()['AgentTaskItem'] = AgentTaskItem
    globals()['PageParams'] = PageParams


class PaginatedResponseAgentTaskItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'count': (int,),  # noqa: E501
            'results': ([AgentTaskItem],),  # noqa: E501
    ...
    def _from_openapi_data(cls, count, results, *args, **kwargs):  # noqa: E501
        """PaginatedResponseAgentTaskItem - a model defined in OpenAPI

        Args:
            count (int):
            results ([AgentTaskItem]):
