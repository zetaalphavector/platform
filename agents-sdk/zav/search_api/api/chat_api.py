...
class ChatApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.respond_endpoint = _Endpoint(
            settings={
    ...
    def respond(
        ...
        **kwargs
        ...
        """Get a response to a conversation with specific a context  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.respond(requester_uuid, chat_response_form, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['chat_response_form'] = \
            chat_response_form
        return self.respond_endpoint.call_with_http_info(**kwargs)
