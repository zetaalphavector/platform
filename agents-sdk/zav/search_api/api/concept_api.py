...
class ConceptApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.concept_get_endpoint = _Endpoint(
            settings={
                'response_type': (Entity,),
                'auth': [],
                'endpoint_path': '/entities/concept/{uid}',
                'operation_id': 'concept_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def concept_get(
        ...
        **kwargs
        ...
        """Get concept information  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.concept_get(uid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['uid'] = \
            uid
        return self.concept_get_endpoint.call_with_http_info(**kwargs)
