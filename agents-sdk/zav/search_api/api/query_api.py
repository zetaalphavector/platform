...
class QueryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.parse_get_endpoint = _Endpoint(
            settings={
                'response_type': (ParseResponse,),
                'auth': [],
                'endpoint_path': '/entities/query',
                'operation_id': 'parse_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def parse_get(
        ...
        **kwargs
        ...
        """Parse query  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.parse_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.parse_get_endpoint.call_with_http_info(**kwargs)
