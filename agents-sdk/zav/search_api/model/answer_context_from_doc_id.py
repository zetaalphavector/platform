...
class AnswerContextFromDocId(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'document_id': (IDString,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, document_id, retrieval_unit, *args, **kwargs):  # noqa: E501
        """AnswerContextFromDocId - a model defined in OpenAPI

        Args:
            document_id (IDString):
    ...
    @convert_js_args_to_python_args
    def __init__(self, document_id, retrieval_unit, *args, **kwargs):  # noqa: E501
        """AnswerContextFromDocId - a model defined in OpenAPI
