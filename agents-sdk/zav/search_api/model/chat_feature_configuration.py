...
class ChatFeatureConfiguration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, default_bot_identifier, *args, **kwargs):  # noqa: E501
        """ChatFeatureConfiguration - a model defined in OpenAPI

        Args:
            default_bot_identifier (str):
        ...
        self.default_bot_identifier = default_bot_identifier
    ...
    @convert_js_args_to_python_args
    def __init__(self, default_bot_identifier, *args, **kwargs):  # noqa: E501
        """ChatFeatureConfiguration - a model defined in OpenAPI
