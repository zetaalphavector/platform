...
def lazy_import():
    ...
    globals()['SearchFilterSettingsFilterTypeSettings'] = SearchFilterSettingsFilterTypeSettings


class SearchFilterSettings(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, field_name, display_name, *args, **kwargs):  # noqa: E501
        """SearchFilterSettings - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, field_name, display_name, *args, **kwargs):  # noqa: E501
        """SearchFilterSettings - a model defined in OpenAPI
