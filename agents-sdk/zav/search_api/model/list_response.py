...
def lazy_import():
    ...
    globals()['DocumentListHit'] = DocumentListHit
...
class ListResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'hits': ([DocumentListHit],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, number_of_pages, total_hits, retrieval_unit, hits, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, number_of_pages, total_hits, retrieval_unit, hits, *args, **kwargs):  # noqa: E501
        """ListResponse - a model defined in OpenAPI
