...
class HitMetadata(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'abstract': (str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, abstract, title, created, date, identifier, identifiers, source, creator, *args, **kwargs):  # noqa: E501
        """HitMetadata - a model defined in OpenAPI

        Args:
            abstract (str, none_type):
            title (str, none_type):
            created (str, none_type):
            date (int, none_type):
    ...
    @convert_js_args_to_python_args
    def __init__(self, abstract, title, created, date, identifier, identifiers, source, creator, *args, **kwargs):  # noqa: E501
        """HitMetadata - a model defined in OpenAPI
